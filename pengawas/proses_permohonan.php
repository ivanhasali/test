<?php 
    ...
    if (isset($_POST['submit_simpan'])) {
        ...
        $sem  = $_POST['semesternya'];
        $thn  = $_POST['tahun_pendidikannya'];
        ...
        if ($cari) {
            ...
            if ($cari2['total'] >= 6) {
                header('location: daftar_permohonan.php?alert=5');
            }
            else {
                ...
                header('location: daftar_permohonan.php?alert=2');
            }
        }
        else{
            if(count($nip_gr) > 6){
                header('location: daftar_permohonan.php?alert=6');
            }
            else{
                $bina = new Permohonan();
    ...
    if (isset($_GET['idhapus'])) {
        ...
        $nip  = $_GET['nip'];
        $id = $_GET['idhapus'];
        $bina2 = new Permohonan();
        $bina2->delete($id);
        header('location: daftar_permohonan.php?alert=4');
    }
?>