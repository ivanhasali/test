                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Data Permohonan</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                ...
                                <div class="add-product">
                                    <a s href="#"  data-toggle="modal" data-target="#PrimaryModalhdbgcl" class="btn btn-custon-four btn-primary"><i class="fa fa-plus edu-informatio" aria-hidden="true"></i> Ajukan Permohonan Binaan</a href="#">
                                    <br>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="nama_sekolah">Sekolah Binaan</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $ni = $_GET['nip'];
                                              ...
                                              $bina = mysqli_query($conn, 
                                                "SELECT pembinaan.*,pengawas.nama_pengawas,sekolah.nama_sekolah from pembinaan JOIN pengawas on pembinaan.nip_pengawas = pengawas.nip_pengawas JOIN sekolah on pembinaan.npsn_sekolah = sekolah.npsn where pembinaan.semester='$sem' AND pembinaan.tahun_pendidikan='$tah' AND pembinaan.nip_pengawas='$ni' AND pembinaan.status='MENUNGGU PERSETUJUAN' ");
                                              $no=0;
                                              foreach ($bina as $bin){
                                              $no++;
                                        ?>
                                        <tr>
                                            ...
                                            <td class="datatable-ct">
                                                <a href="proses_permohonan.php?semester=<?php echo $_GET['semester'] ?>&tahun=<?php echo $_GET['tahun'] ?>&nip=<?php echo $_SESSION['username'] ?>&idhapus=<?php echo $bin['id'] ?>" class="btn btn-custon-four btn-danger"><i class="fa fa-trash edu-informatio" aria-hidden="true"></i> Batalkan</a href="#">
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <?php 
                                            $ni = $_SESSION['username'];
                                              ...
                                              $bina = mysqli_query($conn, 
                                                "SELECT pembinaan.*,pengawas.nama_pengawas,sekolah.nama_sekolah from pembinaan JOIN pengawas on pembinaan.nip_pengawas = pengawas.nip_pengawas JOIN sekolah on pembinaan.npsn_sekolah = sekolah.npsn where  pembinaan.nip_pengawas='$ni' AND pembinaan.status='MENUNGGU PERSETUJUAN' ");
                                              $no=0;
                                              foreach ($bina as $bin){
                                              $no++;
                                        ?>
...
<!---START------------------------------------------------------------------------------------------------------------------------MODAL TAMBAH BINAAN--->
        <div id="PrimaryModalhdbgcl" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header header-color-modal bg-color-1">
                        <h4 class="modal-title" align="center">Ajukan Permohonan Binaan</h4>
                        <div class="modal-close-area modal-close-df">
                            <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                        </div>
                    </div>
                        ...
                        <div class="input-knob-dial-wrap">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="chosen-select-single mg-b-20">
                                        <label >Semester </label>
                                        <select class="form-control" name="semesternya" required>
                        ...
                        <div class="input-knob-dial-wrap">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="chosen-select-single mg-b-20">
                                        <label >Tahun </label>
                                        <input type="text"  class="form-control" name="tahun_pendidikannya" required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="chosen-select-single mg-b-20">
                                        ...
                                        <input type="hidden" name="nip_pengawas" value="<?php echo $ya ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="chosen-select-single mg-b-20">
                                        ...
                                        <select data-placeholder="Pilih Sekolah..." name="npsn_sekolah" class="chosen-select npsnnya" tabindex="-1" required>
