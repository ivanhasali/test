                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Jadwal Pembinaan</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 >Jadwal <span class="table-project-n">Pembinaan</span></h1>
                                  ...
                                  <tr>
                                    ...
                                    $guru = mysqli_query($conn, 
                                        ...
                                        <td class="datatable-ct">
                                            <a href="proses_jadwal.php?id_penjadwalan=<?php echo $bin['id'] ?>" class="btn btn-custon-four btn-warning"><i class="fa fa-calendar edu-informatio" aria-hidden="true"></i> Kelola Jadwal</a href="#">
