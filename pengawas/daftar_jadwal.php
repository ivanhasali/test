                        ...
                        <div class="main-sparkline13-hd">
                            ...
                            <div class="add-product">  
                                <form target="_blank" action="proses_jadwal.php" method="POST">
                                    ...
                                    <button type="submit" name="cetak_submit"  class="btn btn-custon-four btn-success"><i class="fa fa-print edu-informatio" aria-hidden="true"></i> Cetak Data</button href="#">
                                </form>
                            </div>
                                  ...
                                  <tr>
                                    ...
                                    $guru = mysqli_query($conn, 
                                        ...
                                        <td class="datatable-ct">
                                            <a href="proses_jadwal.php?id_penjadwalan=<?php echo $bin['id'] ?>" class="btn btn-custon-four btn-warning"><i class="fa fa-calendar edu-informatio" aria-hidden="true"></i> Jadwal</a href="#">
